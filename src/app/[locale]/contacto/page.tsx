    ...
    <PageTransition>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <MotionReveal animation="fadeUp" className="mb-8 text-center">
              <h2 className="text-2xl font-semibold mb-3">{t('info.title')}</h2>
            </MotionReveal>

            <MotionStagger className="grid md:grid-cols-2 gap-6" animation="fadeUp">
              {/* Email */}
              <div className="card hover:shadow-md transition-shadow duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={CONTACT.EMAIL_HREF} className="text-naranja hover:text-naranja-dark font-medium underline decoration-2 underline-offset-4 break-all">
                      {CONTACT.EMAIL}
                    </a>
      ...
      <section className="bg-gris-100">
        <div className="container py-12">
          <MotionReveal className="bg-white rounded-2xl p-8 shadow-sm overflow-hidden" animation="scale">
            <h2 className="text-xl font-semibold mb-2 text-center">{t('map.title')}</h2>
            <p className="text-gris-600 mb-6 text-center max-w-2xl mx-auto">{t('map.description')}</p>
            <div className="rounded-xl overflow-hidden border border-gris-200 shadow-sm">
              <iframe
                title={t('map.title')}
                src="https://www.google.com/maps?q=Paseo+Rosa+de+los+Vientos+39,+46730+Gand%C3%ADa,+Valencia,+Espa%C3%B1a&output=embed"
                width="100%"
                height="400"
                style={{ border: 0 }}
                loading="lazy"
